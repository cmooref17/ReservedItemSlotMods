...
namespace ReservedWeaponSlot.Config
{
    public static class ConfigSettings
    {
        ...
        public static ConfigEntry<int> numAmmoSlots;
        public static ConfigEntry<int> overrideExtraAmmoSlotPriceIncrease;
        //public static ConfigEntry<bool> combineAmmoSlots;
        ...
        public static void BindConfigSettings()
        {
            ...
            overrideAmmoSlotPriority = AddConfigEntry(Plugin.instance.Config.Bind("Server-side", "AmmoSlotPriorityOverride", -100, "[Host only] Manually set the priority for this item slot. Higher priority slots will come first in the reserved item slots, which will appear below the other slots. Negative priority items will appear on the left side of the screen, this is disabled in the core mod's config."));
            ...
            numAmmoSlots = AddConfigEntry(Plugin.instance.Config.Bind("Server-side", "NumAmmoSlots", 1, "[Host only] Sets the number of reserved ammo slots. Only applies if this slot is enabled.\nNOTE: Ammo does NOT currently stack into one slot at this time. This is on my TODO list."));
            overrideExtraAmmoSlotPriceIncrease = AddConfigEntry(Plugin.instance.Config.Bind("Server-side", "ExtraAmmoSlotsPriceIncreaseOverride", 10, "[Host only] If multiple ammo slots are enabled, and purchasing slots is enabled, the price for each additional ammo slot will go up by this amount."));
            //combineAmmoSlots = AddConfigEntry(Plugin.instance.Config.Bind("Server-side", "CombineAmmoSlots", true, "[Host only] Set to true to consolidate all ammo slots into one slot.\nNOTE: If holding multiple types of ammo"));
