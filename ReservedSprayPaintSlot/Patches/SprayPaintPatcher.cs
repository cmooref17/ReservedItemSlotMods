...
namespace ReservedSprayPaintSlot.Patches
{
	...
	static internal class SprayPaintPatcher
    {
        ...
        public static SprayPaintItem GetReservedSprayPaint(PlayerControllerB playerController) => SessionManager.TryGetUnlockedItemSlotData(Plugin.sprayPaintSlotData.slotName, out var itemSlot) && ReservedPlayerData.allPlayerData.TryGetValue(playerController, out var playerData) ? playerData.GetReservedItem(itemSlot) as SprayPaintItem: null;
