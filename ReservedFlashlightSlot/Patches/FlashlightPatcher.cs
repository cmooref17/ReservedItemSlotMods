...
namespace ReservedFlashlightSlot.Patches
{
	...
	public static class FlashlightPatcher
    {
        ...
        public static FlashlightItem GetReservedFlashlight(PlayerControllerB playerController) => SessionManager.unlockedReservedItemSlots.Contains(Plugin.flashlightSlotData) && ReservedPlayerData.allPlayerData.TryGetValue(playerController, out var playerData) ? playerData.GetReservedItem(Plugin.flashlightSlotData) as FlashlightItem : null;
